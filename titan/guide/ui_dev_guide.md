> ⚠️ [guide/ 이관 시 경고, 2026-08-31] 2026-07-10 기준 작성 — 이후 코드가 많이 바뀌었을 수
> 있음. 특히 여기서 다루는 `Monitor1Widget` 체계 자체가 2026-08-31 사용자 확인상 이미
> 레거시(현재는 `SelfDefenseMonitor1/2Widget` 등) — 위젯 이름/구조는 최신이 아닐 가능성 높음,
> 실제 동작은 에디터로 재확인 권장.
