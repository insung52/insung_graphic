...
2026-09-13 / **★ AI 층 동작 확인** / 병사가 스스로 보고·듣고·전달받고·제압당하고·쏘고·엄폐한다.
**다음은 목표(objective)다** — 지금은 노출만 최적화하므로 병사들이 무모하게 전진한다 → **[D10]**.
...
| **6** | ★★ **목표(objective) 층** — 사수·탈취·방어. **엄폐가 노출만 최적화해서 병사들이 무모하게 기어 나간다** | 다음 큰 조각 → **[D10]** |
