...
| 접두 | 뜻 | 열림 | 해결 |
|---|---|---|---|
| **C** | 측정해야 아는 것 (실험 필요) | 56 (중 1건은 **의도적 미해결**) | 23 |
| **D** | 설계 백로그 (해당 단계에서 채움) | 9 | 1 |
| **Q** | 사용자 결정 필요 | 3 | 11 |
| **R** | 추가 조사 | 5 | 2 |
| **U** | GASP 미확인 | 2 | 5 |
| **W** | 분석에서 파생된 작업 | 31 | 10 (+ **[W20]** · **[W21]** · **[W25]** · **[W33]** · **[W36]** 절반) |
...
| ~~W36~~ | ~~**`GM_SoldierLab` 의 캐릭터 목록이 약 2.5 GB 를 끌고 온다**~~ | ⚠ **비웠으나 그것만으로는 소용없었다 (2026-09-14)** — 실제 경로는 우리 게임모드가 아니라 GASP 원본 **`GM_Sandbox`** 였고, 거기로 가는 길이 `AC_VisualOverrideManager` 와 `PC_Sandbox` **둘**이었다. 그 둘을 끊어 **5532 → 3511 MB**. 4.3절 |
